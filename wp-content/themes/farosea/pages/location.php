...
?>
    ...
    <div class="main-ct location-page" id="kieuhanh">
        ...
        <div class="box-ct-2">
            <div class="title-01 tt-vang-1 wow fadeInUp" data-wow-delay="1s">
                <p>Tâm điểm</p>
                <a href="#"><img src="<?php echo get_template_directory_uri() ?>/images/vang-vn.png" alt="" /></a>
                <p>Kết nối danh lam</p>
            </div>
            <div class="ctent-01 ct-vang-1 wow fadeInUp" data-wow-delay="1s">
